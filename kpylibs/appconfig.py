...
class AppConfig(Singleton):
	...
	def init(self, filename, main_file_path=None, use_home_dir=False, app_name=None):
	...
	def _before_save(self, config):
		...
		for fidn, fname in izip(xrange(len(last_open_files)), last_open_files):
	...
	def set_items(self, section, key, items):
		...
		for idx, item in izip(xrange(len(items)), items):
